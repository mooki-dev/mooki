...
- **Les WebSockets** : au-delà du chat en temps réel
...
- **Neovim** : pourquoi et comment faire la transition
...
- **Les signes astrologiques du développeur** : quel framework es-tu ? (article humoristique et léger)
...
- **Docker pour les nuls** : le guide ultime pour débutants
- **Docker Compose** : orchestrer sans se prendre la tête (la version la plus recente, compose.yaml, bien regarder la documentation officielle)
- **Le cache Docker qui te fait gagner 10 minutes par build**

## 🏗️ DevContainers : Le futur du dev

- **Créer le DevContainer parfait** : de zéro à héros en 30 minutes
- **DevContainers + Codespaces** : coder depuis ton iPad à la plage
- **Les features qu'on oublie toujours dans les DevContainers** (spoiler: les git hooks)
...
## 🎧 Vibe Coding : L'art de l'ambiance
...
- **"OAuth2 + Spring : l'authentification Spring"**
